...
* на мобильных устройствах дни можно сворачивать и разворачивать;
* отображается время последнего обновления расписания в МСК.

### Для администратора

* вход по паролю;
* сессия в HttpOnly cookie;
* редактирование названия, преподавателя и кабинета;
* два режима времени: «Автоматически» и «Вручную»;
* автоматическая подстановка времени пары по её номеру;
* автоматическое скрытие времени для пустых слотов;
* сохранение отдельного урока;
* кнопка «Сохранить всё»;
* маска кабинета `1.19`;
* выбор разного формата времени: автоматический / собственный;
* переключатель пастельной цветовой схемы по дням;
* адаптивное меню управления;
* на мобильных устройствах дни можно сворачивать и разворачивать.
